...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center hero-image">
      {/* Use the global `hero-image` class */}
      <div className="bg-white shadow-lg rounded-lg p-10 max-w-md w-full space-y-6 border border-gray-200">
        <div className="text-center">
          <div className="logo h-16 w-16 mx-auto mb-4"></div> {/* Use the global `logo` class */}
